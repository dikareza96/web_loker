                    ...
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        <span class="input-group-btn">
                          <a href="<?=site_url('backend/data_kategori/form_input_data_kategori');?>" class="btn btn-default" type="button">Tambah</a>
                        </span>
                            ...
                            foreach ($user as $kategori) {
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <a href="<?php echo base_url("backend/data_kategori/edit_data_kategori/$kategori->id_kategori"); ?>"><i class="fa fa-edit"></i></a>
                                  <a href="<?php echo base_url("backend/data_kategori/hapus_data_kategori/$kategori->id_kategori") ?>"><i class="fa fa-close"></i></a>
                                </td>
                              </tr>
                              <?php } ?>
                            </tbody>
