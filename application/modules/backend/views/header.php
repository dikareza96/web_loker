              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-home"></i> Dashboard <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="<?=site_url('backend/data_perusahaan/tampil_data_perusahaan');?>">Data Lowongan</a>
                    </li>
                    
                    
                    
                    <!--fungsi buku tamu untuk orang yang mau meninggalkan pesan dan kritik saran -->
                  </ul>
                </li>
                <li><a><i class="fa fa-desktop"></i> Kategori<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="<?=site_url('backend/data_lokasi/tampil_data_lokasi');?>">Data Lokasi</a> 
                    </li>
                     <li><a href="<?=site_url('backend/data_kategori/tampil_data_kategori');?>">Data Kategori</a> 
                    </li>
